				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">Paid</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">Unpaid</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">Partly Paid</a></li>
						</ul>
					</li>
