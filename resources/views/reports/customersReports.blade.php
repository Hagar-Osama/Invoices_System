...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Reports</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Customers Reports
                </span>
        </div>
    </div>
</div>
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{route('customers.search')}}" method="POST" role="search" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="department_id" class="form-control select2" onclick="console.log($(this).val())" onchange="console.log('change is firing')">
                                <!--placeholder-->
