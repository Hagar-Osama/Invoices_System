        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{route('reports.search')}}" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="col-lg-4">
                        <label class="rdiobox">
                            <input checked name="radio" type="radio" value="1" id="type_div"> <span> Search Invoices
                                By Payment Status</span></label>
                    </div>


                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox"><input name="radio" value="2" type="radio"><span>Searching By Invoice Number
                            </span></label>
                    </div><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10"> Choosing Invoice Type</p><select class="form-control select2" name="type" required>
                                <!--$type?? is equal to isset-->
...
<script>
    //once page is loaded hide search by invoice number bar which has id = 'invoice_number'
    $(document).ready(function() {
        $('#invoice_number').hide();
        //if i clicked radio buttion search invoice by paymnet status show date, invoice type select and hide serach by invoice number bar
        $('input[type="radio"]').click(function() {
            if ($(this).attr('id') == 'type_div') {
                ...
                $('#start_at').show();
                $('#end_at').show();
                //here show search by invoice number bar and hide the rest
            } else {
                $('#invoice_number').show();
                $('#type').hide();
                $('#start_at').hide();
