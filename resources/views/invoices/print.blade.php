                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title"> Collecting Invoice</h1>
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>Department</span>
                                    <span>{{ $invoices->department->name }}</span></p>
                            </div>
                        </div>
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="tx-right">Commission value </th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="tx-center">{{ number_format($invoices->collection_amount, 2) }}</td>
                                        <td class="tx-right">{{ number_format($invoices->commission_value, 2) }}</td>
                                        @php
                                        $total = $invoices->collection_amount + $invoices->commission_value ;
                                        @endphp
                                        <td class="tx-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2">({{ $invoices->tax_value }})</td>
                                    </tr>
                                    <tr>
